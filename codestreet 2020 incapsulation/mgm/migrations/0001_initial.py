# Generated by Django 2.2 on 2020-08-17 20:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mgm.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='mgm.Category')),
            ],
        ),
    ]
